...
$(window).ready(function(){
  ...
  $('.listing-wrap .apartment-list .row').masonry({
    // options
...
$(function(){
  var favTrigger = $('.options');
  $(favTrigger).click(function(event){
    
    $(this).children().toggleClass("glyphicon-heart glyphicon-heart-empty");
    event.preventDefault();
  });
});
